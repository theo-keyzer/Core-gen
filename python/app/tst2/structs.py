...
def do_all(glob, what: List[str], act: int) -> list:
    ret = []
    if what[0] == "Node":
        for i in range(len(glob.dats.ap_node)):
            ret.append( glob.dats.ap_node[i] )
    ...
    if what[0] == "Graph":
        for i in range(len(glob.dats.ap_graph)):
            ret.append( glob.dats.ap_graph[i] )
    if what[0] == "Matrix":
        for i in range(len(glob.dats.ap_matrix)):
            ret.append( glob.dats.ap_matrix[i] )
    if what[0] == "Table":
        for i in range(len(glob.dats.ap_table)):
            ret.append( glob.dats.ap_table[i] )
    if what[0] == "Field":
        for i in range(len(glob.dats.ap_field)):
            ret.append( glob.dats.ap_field[i] )
    if what[0] == "Attrs":
    ...
    if what[0] == "Type":
        for i in range(len(glob.dats.ap_type)):
            ret.append( glob.dats.ap_type[i] )
    if what[0] == "Data":
    ...
    if what[0] == "Domain":
        for i in range(len(glob.dats.ap_domain)):
            ret.append( glob.dats.ap_domain[i] )
    if what[0] == "Model":
    ...
    if what[0] == "Grid":
        for i in range(len(glob.dats.ap_grid)):
            ret.append( glob.dats.ap_grid[i] )
    if what[0] == "Col":
        for i in range(len(glob.dats.ap_col)):
            ret.append( glob.dats.ap_col[i] )
    if what[0] == "R":
    ...
    if what[0] == "Actor":
        for i in range(len(glob.dats.ap_actor)):
            ret.append( glob.dats.ap_actor[i] )
    return ret
