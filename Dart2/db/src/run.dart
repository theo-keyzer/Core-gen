...
Future<int>  do_all(glob, va, lno) async
{
	if (va[0].compareTo("Concept") == 0) {
		if (va.length > 1 && va[1].length > 0) {
			...
			if (en != null) {
				if (va.length > 2) {
					return( await glob.dats.ap_concept[en].do_its(glob, va.sublist(2), lno) );
				}
				return( await go_act(glob, glob.dats.ap_concept[en]) );
			}
			return(0);
		}
	...
	if (va[0].compareTo("Topic") == 0) {
		if (va.length > 1 && va[1].length > 0) {
			...
			if (en != null) {
				if (va.length > 2) {
					return( await glob.dats.ap_topic[en].do_its(glob, va.sublist(2), lno) );
				}
				return( await go_act(glob, glob.dats.ap_topic[en]) );
			}
			return(0);
		}
	...
	if (va[0].compareTo("T") == 0) {
		if (va.length > 1 && va[1].length > 0) {
			...
			if (en != null) {
				if (va.length > 2) {
					return( await glob.dats.ap_t[en].do_its(glob, va.sublist(2), lno) );
				}
				return( await go_act(glob, glob.dats.ap_t[en]) );
			}
			return(0);
		}
	...
	if (va[0].compareTo("Actor") == 0) {
		if (va.length > 1 && va[1].length > 0) {
			...
			if (en != null) {
				if (va.length > 2) {
					return( await glob.dats.ap_actor[en].do_its(glob, va.sublist(2), lno) );
				}
				return( await go_act(glob, glob.dats.ap_actor[en]) );
			}
			return(0);
		}
	...
	if (va[0].compareTo("Comp") == 0) {
		if (va.length > 1 && va[1].length > 0) {
			...
			if (en != null) {
				if (va.length > 2) {
					return( await glob.dats.ap_comp[en].do_its(glob, va.sublist(2), lno) );
				}
				return( await go_act(glob, glob.dats.ap_comp[en]) );
			}
			return(0);
		}
	...
	if (va[0].compareTo("Element") == 0) {
		if (va.length > 1 && va[1].length > 0) {
			...
			if (en != null) {
				if (va.length > 2) {
					return( await glob.dats.ap_element[en].do_its(glob, va.sublist(2), lno) );
				}
				return( await go_act(glob, glob.dats.ap_element[en]) );
			}
			return(0);
		}
	...
	if (va[0].compareTo("Opt") == 0) {
		if (va.length > 1 && va[1].length > 0) {
			...
			if (en != null) {
				if (va.length > 2) {
					return( await glob.dats.ap_opt[en].do_its(glob, va.sublist(2), lno) );
				}
				return( await go_act(glob, glob.dats.ap_opt[en]) );
			}
			return(0);
		}
	...
	if (va[0].compareTo("Ref") == 0) {
		if (va.length > 1 && va[1].length > 0) {
			...
			if (en != null) {
				if (va.length > 2) {
					return( await glob.dats.ap_ref[en].do_its(glob, va.sublist(2), lno) );
				}
				return( await go_act(glob, glob.dats.ap_ref[en]) );
			}
			return(0);
		}
	...
	if (va[0].compareTo("Ref2") == 0) {
		if (va.length > 1 && va[1].length > 0) {
			...
			if (en != null) {
				if (va.length > 2) {
					return( await glob.dats.ap_ref2[en].do_its(glob, va.sublist(2), lno) );
				}
				return( await go_act(glob, glob.dats.ap_ref2[en]) );
			}
			return(0);
		}
	...
	if (va[0].compareTo("Ref3") == 0) {
		if (va.length > 1 && va[1].length > 0) {
			...
			if (en != null) {
				if (va.length > 2) {
					return( await glob.dats.ap_ref3[en].do_its(glob, va.sublist(2), lno) );
				}
				return( await go_act(glob, glob.dats.ap_ref3[en]) );
			}
			return(0);
		}
	...
	if (va[0].compareTo("Refq") == 0) {
		if (va.length > 1 && va[1].length > 0) {
			...
			if (en != null) {
				if (va.length > 2) {
					return( await glob.dats.ap_refq[en].do_its(glob, va.sublist(2), lno) );
				}
				return( await go_act(glob, glob.dats.ap_refq[en]) );
			}
			return(0);
		}
	...
	if (va[0].compareTo("Refu") == 0) {
		if (va.length > 1 && va[1].length > 0) {
			...
			if (en != null) {
				if (va.length > 2) {
					return( await glob.dats.ap_refu[en].do_its(glob, va.sublist(2), lno) );
				}
				return( await go_act(glob, glob.dats.ap_refu[en]) );
			}
			return(0);
		}
	...
	if (va[0].compareTo("Join") == 0) {
		if (va.length > 1 && va[1].length > 0) {
			...
			if (en != null) {
				if (va.length > 2) {
					return( await glob.dats.ap_join[en].do_its(glob, va.sublist(2), lno) );
				}
				return( await go_act(glob, glob.dats.ap_join[en]) );
			}
			return(0);
		}
...
bool load(act, toks, ln, pos, lno)
{
	...
	if ( tok.compareTo( "Dbconn" ) == 0 ) {
		var comp = new KpDbconn();
		var r = comp.load(act, ln, pos, lno, flag);
		if (r == false) {
			errs = true;
		}
